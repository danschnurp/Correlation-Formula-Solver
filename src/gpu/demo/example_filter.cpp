...
///
auto ExampleFilter::bindParameters(vk::Buffer &out, const vk::Buffer &in, const ExampleFilter::PushParams &p
) const -> void {
...
/// run (sync) the filter
auto ExampleFilter::operator()(vk::Buffer &out, const vk::Buffer &in, const ExampleFilter::PushParams &p
) const -> void {
...
auto ExampleFilter::createInstance(const std::vector<const char *> layers, const std::vector<const char *> extensions
  ...
  auto appInfo = vk::ApplicationInfo("Example Filter",
                                     0,
                                     "no_engine",
                                     0,
...
auto ExampleFilter::createPipelineLayout(const vk::Device &device, const vk::DescriptorSetLayout &dscLayout
) -> vk::PipelineLayout {
...
auto ExampleFilter::createComputePipeline(const vk::Device &device,
...
/// family ONLY.
auto ExampleFilter::createCommandBuffer(const vk::Device &device,
